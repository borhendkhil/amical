...
--
-- Hôte : localhost:3306
-- Généré le : mer. 15 mai 2024 à 13:55
...
('med', '2024-05-15', '09:22:18', '2024-05-15', '09:22:18'),
('med', '2024-05-15', '12:18:12', '2024-05-15', '12:18:12'),
('med', '2024-05-15', '12:18:12', '2024-05-15', '12:18:12'),
('med', '2024-05-15', '12:19:21', '2024-05-15', '12:19:21'),
('med', '2024-05-15', '12:19:21', '2024-05-15', '12:19:21'),
('Med', '2024-05-15', '13:01:06', '2024-05-15', '13:01:06'),
('Med', '2024-05-15', '13:01:06', '2024-05-15', '13:01:06');
...
CREATE TABLE `solde` (
  ...
  `etat` varchar(1) NOT NULL DEFAULT '1'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `solde` (`date`, `solde_caisse`, `total_cheque`, `total_espece`, `solde_debut`, `solde_fin`, `solde_mouvement_total`, `solde_mouvement_recette`, `solde_mouvement_depense`, `etat`) VALUES
('2024-04-30', 1155.27, 0.00, 1155.27, 1155.27, 1155.27, 1155.27, 1155.27, 0.00, '1'),
('2024-05-09', 1555.27, NULL, NULL, 0.00, NULL, 200.00, 200.00, NULL, '1'),
('2024-05-13', 1755.27, NULL, NULL, 1555.27, NULL, 200.00, 200.00, NULL, '1');
